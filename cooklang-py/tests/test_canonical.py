...
def test_parsing(file_content: str, expected_result: dict) -> tuple[bool, dict]:
    actual_result = cooklang.parse(file_content)
...
class TestCanonical(unittest.TestCase):
    def test_canonical(self) -> None:
        ...
        with (Path(__file__).parent / "canonical.yaml").open() as tests_input_file:
        ...
        for test in tests_input["tests"]:
            ...
            if r:
                ...
                print(f"Test failed\n{test=}\n{expected_result=}\n{actual_result=}")
                cooklang.parse(tests_input["tests"][test]["source"])
